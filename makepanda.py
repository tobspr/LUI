...
if (PkgSkip("LUI") == 0) and (not RUNTIME):
  ...
  TargetAdd('p3lui_composite1.obj', opts=OPTS, input='p3lui_composite1.cxx')

  TargetAdd('libp3lui.dll', input='p3lui_composite1.obj')
  TargetAdd('libp3lui.dll', input=COMMON_PANDA_LIBS)
  TargetAdd('libp3lui.dll', opts=OPTS)

  OPTS=['DIR:panda/src/lui', 'LUI', 'FREETYPE']
  IGATEFILES=GetDirectoryContents('panda/src/lui', ["*.h"])
  TargetAdd('libp3lui.in', opts=OPTS, input=IGATEFILES)
  TargetAdd('libp3lui.in', opts=['IMOD:panda3d.lui', 'ILIB:libp3lui', 'SRCDIR:panda/src/lui'])
  TargetAdd('libp3lui_igate.obj', input='libp3lui.in', opts=["DEPENDENCYONLY"])

  TargetAdd('lui_module.obj', input='libp3lui.in')
  TargetAdd('lui_module.obj', opts=OPTS)
  TargetAdd('lui_module.obj', opts=['IMOD:panda3d.lui', 'ILIB:lui'])
...
if (PkgSkip("PYTHON")==0 and not RUNTIME):
  ...
  if (PkgSkip("LUI")==0):
    TargetAdd('PandaModules.py', input='lui.pyd')
